...
Public project documents that are useful outside day-to-day development live here.
...
- `../tools/generate_social_preview.ps1`: regenerates the social preview asset.
