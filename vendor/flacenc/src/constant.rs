...
mod built {
    pub static PROFILE: &str = match option_env!("PROFILE") {
        Some(v) => v,
        None => "unknown",
    };
    pub static PKG_VERSION: &str = env!("CARGO_PKG_VERSION");
    pub static FEATURES_LOWERCASE_STR: &str = match option_env!("CARGO_CFG_FEATURE") {
        Some(v) => v,
        None => "",
    };
    pub static RUSTC_VERSION: &str = match option_env!("RUSTC") {
        Some(v) => v,
        None => "unknown",
    };
}
